...
metrics = {
    "fault": Gauge("fault", "Device fault code", registry=registry),
    "power_fault": Gauge("power_fault", "Power fault flag", registry=registry),
    "load_power": Gauge("load_power_watts", "Load power (W)", registry=registry),
    "load_current": Gauge("load_current_amps", "Load current (A)", registry=registry),
    "overpower_value": Gauge(
        "overpower_value", "Overpower threshold", registry=registry
    ),
    "lowpower_switch": Gauge(
        "lowpower_switch", "Low power threshold", registry=registry
    ),
    "lowpower_reset": Gauge(
        "lowpower_reset", "Low power reset threshold", registry=registry
    ),
    "totalele_add": Gauge(
        "totalele_add", "Total accumulated energy (Wh) from inverter", registry=registry
    ),
    "dwele_add": Gauge(
        "dwele_add", "Total accumulated energy (Wh) from grid", registry=registry
    ),
    "voltage_l1": Gauge("voltage_l1_volts", "L1 voltage (V)", registry=registry),
    "voltage_l2": Gauge("voltage_l2_volts", "L2 voltage (V)", registry=registry),
    "voltage_batt": Gauge(
        "voltage_battery_volts", "Battery voltage (V)", registry=registry
    ),
    "power_mode": Gauge(
        "power_mode", "Power source (0=grid,1=inverter)", registry=registry
    ),
}
